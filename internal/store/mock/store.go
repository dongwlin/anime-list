...
// Source: github.com/dongwlin/anime-list/internal/store (interfaces: Store)
//
...
func (m *MockStore) CountSeason(arg0 context.Context, arg1 int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountSeason", arg0, arg1)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountSeason indicates an expected call of CountSeason.
func (mr *MockStoreMockRecorder) CountSeason(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountSeason", reflect.TypeOf((*MockStore)(nil).CountSeason), arg0, arg1)
}

// CountTheater mocks base method.
func (m *MockStore) CountTheater(arg0 context.Context, arg1 int64) (int64, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CountTheater", arg0, arg1)
	ret0, _ := ret[0].(int64)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// CountTheater indicates an expected call of CountTheater.
func (mr *MockStoreMockRecorder) CountTheater(arg0, arg1 any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CountTheater", reflect.TypeOf((*MockStore)(nil).CountTheater), arg0, arg1)
}

// CreateAnime mocks base method.
func (m *MockStore) CreateAnime(arg0 context.Context, arg1 sqlc.CreateAnimeParams) (sqlc.Anime, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateAnime", arg0, arg1)
	ret0, _ := ret[0].(sqlc.Anime)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateEpisode(arg0 context.Context, arg1 sqlc.CreateEpisodeParams) (sqlc.Episode, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateEpisode", arg0, arg1)
	ret0, _ := ret[0].(sqlc.Episode)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateSeason(arg0 context.Context, arg1 sqlc.CreateSeasonParams) (sqlc.Season, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateSeason", arg0, arg1)
	ret0, _ := ret[0].(sqlc.Season)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) CreateTheater(arg0 context.Context, arg1 sqlc.CreateTheaterParams) (sqlc.Theater, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateTheater", arg0, arg1)
	ret0, _ := ret[0].(sqlc.Theater)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockStore) GetAnime(arg0 context.Context, arg1 int64) (sqlc.Anime, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetEpisode(arg0 context.Context, arg1 int64) (sqlc.Episode, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetSeason(arg0 context.Context, arg1 int64) (sqlc.Season, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) GetTheater(arg0 context.Context, arg1 int64) (sqlc.Theater, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListAnime(arg0 context.Context, arg1 sqlc.ListAnimeParams) ([]sqlc.Anime, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListEpisode(arg0 context.Context, arg1 sqlc.ListEpisodeParams) ([]sqlc.Episode, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListSeason(arg0 context.Context, arg1 sqlc.ListSeasonParams) ([]sqlc.Season, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) ListTheater(arg0 context.Context, arg1 sqlc.ListTheaterParams) ([]sqlc.Theater, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateAnime(arg0 context.Context, arg1 sqlc.UpdateAnimeParams) (sqlc.Anime, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateEpisode(arg0 context.Context, arg1 sqlc.UpdateEpisodeParams) (sqlc.Episode, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateSeason(arg0 context.Context, arg1 sqlc.UpdateSeasonParams) (sqlc.Season, error) {
	m.ctrl.T.Helper()
...
func (m *MockStore) UpdateTheater(arg0 context.Context, arg1 sqlc.UpdateTheaterParams) (sqlc.Theater, error) {
	m.ctrl.T.Helper()
